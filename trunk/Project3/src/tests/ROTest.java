...
class ROTest extends TestDriver {
	...
	private static final int SUPER_SIZE = 5000;
...
//		} // protected boolean test3()
	...
	protected boolean test4(){
		...
		// Scan through.
		try{
			FileScan keyScan = new FileScan(s_drivers, file);

			while(keyScan.hasNext()){
				Tuple scannedTuple = keyScan.getNext();
	...
	protected boolean test5(){
		...
		// Scan through.
		try{
			KeyScan keyScan = new KeyScan(s_drivers, index, new SearchKey((float)(2 * 7.7)), file);
...
//				new Predicate(AttrOperator.GT, AttrType.FIELDNO, 3, AttrType.FLOAT,	65F),
		...
		// Invoke: hasNext, getNext, hasNext
		System.out.println(sel.hasNext());
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());
		
		sel.restart();
		System.out.println();
		
		// Invoke: getNext, hasNext
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());		
		...
		// Invoke: hasNext, hasNext, hasNext
		System.out.println(sel.hasNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.hasNext());
	...
	protected boolean test8(){
		...
		Predicate[] preds = new Predicate[] {
//				new Predicate(AttrOperator.GT, AttrType.FIELDNO, 3, AttrType.FLOAT,	65F),
				new Predicate(AttrOperator.LT, AttrType.FIELDNO, 3, AttrType.FLOAT, 100F)
		};
		
		FileScan scan = new FileScan(s_drivers, file);
		Selection sel = new Selection(scan, preds);
		
		// Invoke: hasNext, hasNext, getNext, getNext, hasNext
		System.out.println(sel.hasNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.getNext());
		System.out.println(sel.getNext());
		...
		// Invoke: getNext, getNext, hasNext, hasNext
		System.out.println(sel.getNext());
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.hasNext());
		...
		// Invoke: getNext, hasNext, getNext, hasNext
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());
		...
		// Invoke: getNext, hasNext, hasNext, getNext, hasNext
		System.out.println(sel.getNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.hasNext());
		System.out.println(sel.getNext());
...
//			Schema joinSchema = Schema.join(s_drivers, s_rides);
//			
//			System.out.println("Schema for (D X R)");
//			joinSchema.print();
			
			Predicate[] preds = new Predicate[] {new Predicate(AttrOperator.EQ, AttrType.FIELDNO, 0, 
					AttrType.FIELDNO, 5)};			
			SimpleJoin simpleJoin = new SimpleJoin(new FileScan(s_drivers, drivers), 
...
//			saveCounts("h_join");
			...
			// that's all folks!
			System.out.print("\n\nTest 9 completed without exception.");
			return PASS;

		} catch (Exception exc) {

			exc.printStackTrace(System.out);
			System.out.print("\n\nTest 9 terminated because of exception.");
			return FAIL;
